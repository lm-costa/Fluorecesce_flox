...
The method for correting Fluorescence by re-absortion *(Frc)* is based on the *Cesana (2021)* thesis. 
...
Now we are gonna agreggate the table and compare to the gpp file . The description can be found in [here]()
