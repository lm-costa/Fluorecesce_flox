...
This data consist... 
in  a similar way of the following [repository](https://github.com/lm-costa/draft_bepe) we are gonna retrivied some metrics for the partial and clear sky days together. This table are already pre-proced. 
